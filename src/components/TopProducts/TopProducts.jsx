...
const ProductsData = [
  {
    ...
    title: "Casual Wear",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipisicing elit.  ipsum quos quasi quam molestias error voluptatem modi facilis vitae.",
  },
  {
    id: 2,
    img: Img2,
      ...
      <div className="container">
        ...
        <div className="text-left mb-24">
          ...
          >
            ...
            iure ab, aperiam, hic natus quo soluta odit eligendi totam
            aspernatur inventore voluptatu
          </p>
        </div>
        {/* Body Section */}
        <div
          className="grid grid-cols-1 sm:grid-cols-2
         md:grid-cols-3 gap-20 mad:gap-5 place-items-center"
        >
