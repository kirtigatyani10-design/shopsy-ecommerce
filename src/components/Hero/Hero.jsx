...
const Hero = () => {
  ...
  return (
    <div
      className=" container relative overflow-hidden max-h-[720px] h-screen md:h-[650px]
      sm:min-h-[650px] bg-gray-100 flex justify-center 
      items-center dark:bg-gray-950 dark:text-white duration-200"
    >
      {/* background pattern */}
      <div 
        className=" container h-[700px] w-[700px] bg-primary/40 
                ...
                <div className="order-1 sm:order-2">
                  <div className="relative z-10">
                    <img
                      src={item.img}
                      alt=""
                      className="w-[300px] h-[300px] sm:w-[450px]
